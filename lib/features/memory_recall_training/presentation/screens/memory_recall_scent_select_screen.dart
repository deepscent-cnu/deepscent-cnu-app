                ...
                children: [
                              ...
                              child: OutlinedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => const MemoryRecallTrainingScreen(),
                                    ),
                                  );
                                },
                                style: OutlinedButton.styleFrom(
                                  ...
                                  side: const BorderSide(color: Color(0xFF335928)),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          width: MediaQuery.of(context).size.width * 0.5 - 48, // 좌우 padding 고려
